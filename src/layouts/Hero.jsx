...
const Hero = () => {
  ...
  return (
    <section className="flex items-center justify-center w-full h-full z-10 mt-28">
      <div className="container flex flex-col items-center justify-between gap-10 px-6 py-6 mx-auto md:flex-row sm:px-16">
